...
namespace CorpoGameApp.Migrations
{
    ...
    [Migration("20170414190832_add_player_queue")]
    partial class add_player_queue
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CorpoGameApp.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CorpoGameApp.Models.PlayerQueueItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PlayerQueueItems");
                });

            modelBuilder.Entity("CorpoGameApp.Models.QueueItemState", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("CorpoGameApp.Models.PlayerQueueItem", b =>
                {
                    ...
                    b.HasOne("CorpoGameApp.Models.QueueItemState", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CorpoGameApp.Models.ApplicationUser")
                        .WithMany("Claims")
